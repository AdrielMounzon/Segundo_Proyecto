...
describe("IMPLEMENTACION DEL EXAMEN", () => {
  ...
  it("deberia seguir avanzando al este",()=>
  {
    var juego=new Juego();
    juego.DefinirTablero(5,5);
    juego.DefinirPosicionInicialDelAuto(3,3,"E");
    juego.ejecutarComandosMovimiento("AAA");
    expect(juego.PosicionFinal()).toEqual("1,3E");
  });
  ...
  it("deberia seguir avanzando al oeste",()=>
  {
    var juego=new Juego();
    juego.DefinirTablero(5,5);
    juego.DefinirPosicionInicialDelAuto(0,0,"O");
    juego.ejecutarComandosMovimiento("AAA");
    expect(juego.PosicionFinal()).toEqual("2,0O");
  });
  it("el auto deberia seguir avanzando al oeste con comando J",()=>
  {
    var juego=new Juego();
    juego.DefinirTablero(5,5);
    juego.DefinirPosicionInicialDelAuto(0,0,"O");
    juego.ejecutarComandosMovimiento("JA");
    expect(juego.PosicionFinal()).toEqual("2,0O");
  });
});
