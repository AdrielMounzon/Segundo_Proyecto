...
describe("Implementaciones segundo examen", ()=>{
  ...
  it("el auto debería poder avanzar con dirección este una vez que ha llegado al límite",()=>{
    var juego=new Juego();
  ...
  it("el auto debería poder avanzar con dirección oeste una vez que ha llegado al límite",()=>{
    var juego=new Juego();
